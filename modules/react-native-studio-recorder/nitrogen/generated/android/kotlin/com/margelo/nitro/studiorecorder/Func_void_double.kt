...
/**
 * Represents the JavaScript callback `(db: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(db: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @FastNative
  private external fun invoke_cxx(db: Double): Unit
}
