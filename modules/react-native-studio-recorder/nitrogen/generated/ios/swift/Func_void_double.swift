...
/**
 * Wraps a Swift `(_ db: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.studiorecorder.bridge.swift

  private let closure: (_ db: Double) -> Void

  public init(_ closure: @escaping (_ db: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(db: Double) -> Void {
    self.closure(db)
  }
